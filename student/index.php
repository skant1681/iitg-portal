...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Welcome To Student Profile</a></span></h2>
                ...
                <table width="100%" border="0">
                  ...
                  <tr>
                    <td bgcolor="#A0B9F3"><div align="center"><a href="Registration.php"><strong>Registration For Companies</strong></a></div></td>
